...
#[gpui::test]
fn read_only_space_does_not_toggle_or_call_change_handler(cx: &mut TestAppContext) {
...
#[gpui::test]
fn read_only_enter_does_not_toggle_or_call_change_handler(cx: &mut TestAppContext) {
    let window = open_switch(
        cx,
        SwitchTestConfig {
            read_only: true,
